...
class VariationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variation" do
    assert_difference('Variation.count') do
      post variations_url, params: { variation: { approved: @variation.approved, price: @variation.price, project_id: @variation.project_id, project_item_id: @variation.project_item_id } }
    end
  ...
  test "should update variation" do
    patch variation_url(@variation), params: { variation: { approved: @variation.approved, price: @variation.price, project_id: @variation.project_id, project_item_id: @variation.project_item_id } }
