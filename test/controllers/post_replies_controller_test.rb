...
class PostRepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_reply" do
    assert_difference('PostReply.count') do
      post post_replies_url, params: { post_reply: { content: @post_reply.content, post_id: @post_reply.post_id } }
    end
  ...
  test "should update post_reply" do
    patch post_reply_url(@post_reply), params: { post_reply: { content: @post_reply.content, post_id: @post_reply.post_id } }
