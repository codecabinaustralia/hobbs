...
class TipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post tips_url, params: { tip: { content: @tip.content, item_group_id: @tip.item_group_id } }
    end
  ...
  test "should update tip" do
    patch tip_url(@tip), params: { tip: { content: @tip.content, item_group_id: @tip.item_group_id } }
